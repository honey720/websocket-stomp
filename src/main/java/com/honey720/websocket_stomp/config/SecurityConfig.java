...
import com.honey720.websocket_stomp.security.filter.JWTFilter;
import com.honey720.websocket_stomp.security.filter.LoginFilter;
...
public class SecurityConfig {
    ...
    /**
     * Spring Securty의 AuthenticationManager를 빈으로 등록
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        return request -> {
            ...
            configuration.setAllowedHeaders(Collections.singletonList("Authorization")); // Authorization 헤더 노출
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/login", "/signUp", "/login.html", "/signup.html", "/index.html", "/chat.html").permitAll()
                        .requestMatchers("/ws-stomp/**").permitAll() // WebSocket 핸드셰이크 허용
